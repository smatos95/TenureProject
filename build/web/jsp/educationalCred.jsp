                        ...
                        <table id ="insertTables">
                            <%
                                ...
                                while (degsItr.hasNext()) {
                                    ...
                                    out.print("<tr>");
                                    deg.printSummaryRow(out);
                                    out.println("<td><button onclick='clickPopup()' class ='action_button' type='submit' formaction='EduCredAutofillServlet' name='updateCred' value='" + deg.getDegreeID() + "'>Edit</button> <button class ='action_button' type='submit' id='" + idName + "' formaction='UpdateEduCredServlet' onClick='whileDeleteEduCred(" + i + ")' value='" + deg.getDegreeID() + "'>Delete</button></td>");
                                    out.println("</tr>");
                                    i++;
                                }
                                out.println("</table>");%>
