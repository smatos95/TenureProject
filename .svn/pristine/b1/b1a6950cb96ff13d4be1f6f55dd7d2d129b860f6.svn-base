...
/**
 * Trampoline servlet for removing a record selected on the page <code>BuTeachingHistory.jsp</code>.
 * 
 * @author Gryphon Ayers (2019)
 */


@WebServlet(name = "BUTeachDeleteServlet", urlPatterns = {"/BUTeachDeleteServlet"})
public class BUTeachDeleteServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        // If the request was cancelled then send back to the same page
        if(request.getParameter("cancel") != null)
        {
            ...
            if(expNumber == -1) {
                ...
                if(e.getApplication() == app.getApplicationID() &&
                    ...
                    lxm.deleteLocalExp(e.getLocalExpID());
                }
            }
        }
