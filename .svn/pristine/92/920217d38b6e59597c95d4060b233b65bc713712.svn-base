 ...
 */
@WebServlet(name = "PrintUniCommServlet", urlPatterns = {"/PrintUniCommServlet"})
public class PrintUniCommServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String headerValue = String.format("attachment; filename=\"%s\"", "ContribToUniAndCommunityNarrative.docx");
