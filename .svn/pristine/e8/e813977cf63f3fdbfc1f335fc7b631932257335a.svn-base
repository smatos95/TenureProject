...
<html>
    ...
    <body bgcolor="#F4ECD9">
        ...
        <div id="timeActivities" class="tabcontent">
            <div class="paper">
              <div class="paperTop">
                <div class="pageTitle">Assigned Time Activities</div>
                <center><div>
              ...
              <div class="footerButtons">
                ...
                <form id='redirct_page' action='RedirectServlet' method='POST'>
                    ...
                    <input type="submit" name="fulfillmentProfessional" value="Back"/>
                    <input type="submit" name="Innovations" value="Continue"/>                            
                </form>
                <form id='redirct_page' action='RedirectServlet' method='POST'>                 
                    <!--skip button-->                    
                    <input type="submit" name="Innovations" value="Skip"/>
                </form>
              </div>
            </div>
        </div> 
