 ...
 * @author jtg79323
 */
@WebServlet(name = "OtherWorkExperienceDeleteServlet", urlPatterns =
{
    "/OtherWorkExperienceDeleteServlet"
})
public class OtherWorkExperienceDeleteServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        {
            Integer workNumber = Integer.parseInt(request.getParameter("deleteWork"));
            if(workNumber == -1)
            {
