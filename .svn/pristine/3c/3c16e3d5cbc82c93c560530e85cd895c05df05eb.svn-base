...
<html>
    <head>
        <title>Chair Narrative Signatures</title>
    ...
    <body bgcolor="#F4ECD9">
        ...
        <div id="chairNarrativeSigPage" class="tabcontent">
            <div class="paper">
              <div class="paperTop">
                <div class="pageTitle">Chairperson Narrative and Signature Page</div>
                <center><div>
            ...
            <div class="footerButtons">
                ...
                <form id='redirct_page' action='RedirectServlet' method='POST'>
                    ...
                    <input type="submit" name="deptNarrativeSigPage" value="Back"/>
                    <input type="submit" name="specialNote" value="Continue"/>
                </form>
                <form id='redirct_page' action='RedirectServlet' method='POST'>                 
                    <!--skip button-->                    
                    <input type="submit" name="specialNote" value="Skip"/>
                </form>
            </div>
          </div>
        </div> 
