 ...
 */
@WebServlet(name = "PrintTeachingFulfillmentServlet", urlPatterns = {"/PrintTeachingFulfillmentServlet"})
public class PrintTeachingFulfillmentServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String headerValue = String.format("attachment; filename=\"%s\"", "ProfessionalResponsibilitiesNarrative.docx");
