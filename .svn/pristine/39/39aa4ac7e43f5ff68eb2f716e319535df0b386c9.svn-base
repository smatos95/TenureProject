...
<html>
    <head>
        <title>Student Organizations & Advisement</title>
    ...
    <body bgcolor="#F4ECD9">
        ...
        <div id="studentOrgAdvisement" class="tabcontent">
            <div class="paper">
              <div class="paperTop">
                <div class="pageTitle">Advisement to Student Organizations</div>
                <center><div>
            ...
            <div class="paperContents">            
                <div class="fieldLayout">Name of Organization
                    <input id="orgName" type="text" class="generalTextboxStyle" name="orgName">
                </div>                
                ...
                <div class="fieldLayout">Responsibilities
                    <!--MIGHT NEED TO REPLACE WITH SELECTION-->
                    <input id="orgType" type="text" class="generalTextboxStyle" name="orgResponsibilities">
                </div>
            ...
            <div class="footerButtons">
                ...
                <form id='redirct_page' action='RedirectServlet' method='POST'>
                    <input type="submit" hidden="hidden" id="save_hidden_button">
                     <input type="submit" name="committeeService" value="Back"/>
                    <input type="submit" name="otherContributions" value="Continue"/>
                                 
                </form>
                <!--Skip button-->
                <form id='redirct_page' action='RedirectServlet' method='POST'>                    
                        <input type="submit" name="otherContributions" value="Skip"/>
                </form>  
            </div>
           </div>
        </div> 
