 ...
 */
@WebServlet(name = "UpdateUniCommServlet", urlPatterns = {"/UpdateUniCommServlet"})
public class UpdateUniCommServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (narr != null) {
            narr.setNarrativeText(request.getParameter("UniCommNarr"));
