...
import static utilities.EmailUtility.email;
...
public class ContextListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent event) {
       ...
       //How to get the actual path to a relative directory
        ...
        WebErrorLogger.log(Level.INFO, "BUlogin web application Context Loaded");
//        String adminEmail = PropertyManager.getProperty("AdminEmail");
//        email(adminEmail,"BUlogin Web Application Test Error Message", "BUlogin Web Application Test Error Message");
